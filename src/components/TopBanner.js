...
const TopBanner = () => {
  return (
    <div className="bg-[#EAFFFC] h-96 mt-8 w-[100%] max-w-screen-xl mx-auto p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 justify-items-center items-center gap-4">
      <div className="p-2">
        <p className="text-xl md:text-4xl font-bold ml-5 p-4">
